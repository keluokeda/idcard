...
import com.ke.idcard.utils.CameraConfigurationManager;
...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public float getScale() {
        ...
        if (mCameraConfigurationManager != null) {
            ...
            float Wscale=((float)mCameraConfigurationManager.getCameraResolution().x /(float) CardScreenUtil.getScreenResolution(getContext()).x);
